const data={
about:{label:"01 / IDENTITY",title:"Muhammad<br><em>Arsalan.</em>",sub:"IT Support professional with a Master of Computer Science and hands-on experience across technical support, systems, documentation and aviation operations.",rows:[["FOCUS","IT SUPPORT / OPERATIONS / AI"],["EDUCATION","MASTER OF COMPUTER SCIENCE"],["APPROACH","TROUBLESHOOT → RESOLVE → DOCUMENT"],["LOCATION","SAUDI ARABIA"]]},
...
achievements:{label:"05 / ACHIEVEMENTS",title:"Proof of<br><em>growth.</em>",sub:"Real milestones from my education and professional development.",rows:[["EDUCATION","Master of Computer Science · Superior University · 2022 · GPA 3.23 / 4.00"],["TECHNICAL","Hands-on Level 1/2 IT support across Windows, macOS, Microsoft 365, Active Directory, hardware and network issues"],["OPERATIONS","Current aviation technical documentation and planning environment using CAMP and TRAX"],["FOUNDATION","Computer Science education plus Graphic Designer Diploma and practical creative technology experience"]]},
